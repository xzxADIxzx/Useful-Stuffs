...
public class SelectMenu extends Menu {
    ...
    public <T> SelectMenu(Func<MenuView, Iterable<T>> content, Func<T, String> button, Action2<MenuView, T> action) {
        this(1, content, button, action);
    }
    ...
    public <T> SelectMenu(String close, Func<MenuView, Iterable<T>> content, Func<T, String> button, Action2<MenuView, T> action) {
        this(close, 1, content, button, action);
    }
    ...
    public <T> SelectMenu(int optionsPerRow, Func<MenuView, Iterable<T>> content, Func<T, String> button, Action2<MenuView, T> action) {
        this("ui.button.close", optionsPerRow, content, button, action);
    }
    ...
    public <T> SelectMenu(String close, int optionsPerRow, Func<MenuView, Iterable<T>> content, Func<T, String> button, Action2<MenuView, T> action) {
        this.transform(menu -> {
